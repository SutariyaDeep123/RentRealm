...
export default function EditHotel({ params }) {
  ...
  useEffect(() => {
    const fetchHotel = async () => {
      try {
        ...
        setSelectedAmenities(hotelData.amenities.map((amenity)=>amenity._id))
    ...
    fetchHotel();
    console.log('from dattabase ',selectedAmenities)
  }, [hotelId]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append('amenities', selectedAmenities);
